...
@section('content')
    <main>
        <div class="container">
            ...
            <div id="serieslist">
                <div class="thumb">
                    <a href=" {{ route('test') }} "><img src="https://www.dccomics.com/sites/default/files/styles/covers192x291/public/comic-covers/2018/09/AC1000_DLX_162-001_HD_5ba13723281ab0.37845353.jpg?itok=ZsI-C5eX" alt="Action Comics"></a>
                    <h4>Action Comics</h4>
                </div>
                <div class="thumb">
